...
public class GClass45 : GClass42
{
  public GClass49 eff;
  private int int_0;
  private int int_1;
  ...
  public static void smethod_0(int id, int cx, int cy, int loopCount) => GClass42.gclass134_0.method_0((object) new GClass45()
  {
  ...
  public override void vmethod_0()
  {
    if ((this.long_0 == 0L ? 1 : 0) == 0)
    {
      ...
      if (GClass126.smethod_18() - this.long_0 > (long) Class15.smethod_0(0))
        GClass42.gclass134_0.method_8((object) this);
    }
    else
    {
      this.int_0 += Class15.smethod_0(1);
