...
public class GClass3
{
  ...
  public int[] imgId = new int[Class15.smethod_0(5)];
  ...
  {
    int index = GClass3.smethod_0(GClass151.smethod_5(this.axTo - this.ax, -(this.ayTo - this.ay)));
    GClass169.smethod_6(g, this.imgId[(int) GClass3.sbyte_0[index]], this.ax, this.ay, GClass3.int_1[index], GClass98.int_1 | GClass98.int_0);
  }

  public static int smethod_0(int angle)
  {
    for (int index = Class15.smethod_0(0); index < GClass3.int_0.Length - Class15.smethod_0(1); index += Class15.smethod_0(1))
    {
      if (angle >= GClass3.int_0[index] && angle <= GClass3.int_0[index + Class15.smethod_0(1)])
